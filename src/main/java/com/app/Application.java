...
public class Application {
    ...
    /**
     * Defines a bean with "prototype" scope.
     * In Spring, a prototype-scoped bean results in the creation of a new instance 
     * each time it is requested from the container. This is useful when you need 
     * stateful or non-shared instances.
     * 
     * @return a new instance of ScopedBean every time it is requested
     */
    @Bean
    @Scope("prototype")
    ...
    public static void main(String[] args) {
        ...
        // Retrieve beans and perform tests
